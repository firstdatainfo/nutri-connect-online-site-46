...
const MapComponent: React.FC<MapProps> = ({
  ...
  // Barra do Garças Longitude
  defaultLatitude = -15.8901,
  // Barra do Garças Latitude
  defaultZoom = 12
}) => {
  ...
  useEffect(() => {
    ...
    map.current = new mapboxgl.Map({
      ...
      // Using streets style for city view
    ...
    new mapboxgl.Marker().setLngLat([defaultLongitude, defaultLatitude]).addTo(map.current);
