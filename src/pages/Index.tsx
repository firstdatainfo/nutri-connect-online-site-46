...
const Index = () => {
  ...
  return <>
      ...
      <main className="overflow-hidden">
        <Hero title="Lidiane Dos Reis" subtitle="Nutricionista Clínica Integrativa, Esportiva, Estética, Microbiota Intestinal e Genômica" ctaText="Agende uma Consulta" ctaLink="/consultation" profileImage="/lovable-uploads/eb101949-77ca-4a72-80ff-91e3190e410a.png" image="https://images.unsplash.com/photo-1494597564530-871f2b93ac55?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1513&q=80" showWave={false} reducedSpacing={true} />
          ...
          <div className="container-custom">
            <div className="flex flex-col md:flex-row items-center justify-between mb-6 md:mb-10 gap-4">
              <div className="max-w-3xl">
                <h2 className="text-2xl font-bold mb-3 py-[27px] md:text-3xl">Cuidado Individualizado e Especialização de Qualidade</h2>
