        ...
        <section className="section-padding bg-white">
          <div className="container-custom">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <div className="text-center p-6 rounded-lg bg-nutrition-light-green/10 hover:bg-nutrition-light-green/20 transition-colors">
                <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-nutrition-green text-white mb-4">
                  <Phone size={24} />
                </div>
              ...
              <div className="text-center p-6 rounded-lg bg-nutrition-light-blue/10 hover:bg-nutrition-light-blue/20 transition-colors">
                <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-nutrition-blue text-white mb-4">
                  <Mail size={24} />
                </div>
              ...
              <div className="text-center p-6 rounded-lg bg-nutrition-light-green/10 hover:bg-nutrition-light-green/20 transition-colors">
                <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-nutrition-teal text-white mb-4">
                  <Instagram size={24} />
                </div>
