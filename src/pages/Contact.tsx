  ...
  return (
    <>
      ...
      <main>
        <Hero
          title="Contact Us"
          subtitle="Have questions or want to learn more about our services? Reach out to us today."
          ctaText=""
          ctaLink=""
          showWave={false}
          ...
          <div className="container-custom">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-8">
                  We're here to answer your questions and provide support on your nutrition journey.
                </p>
                ...
                <div className="space-y-8">
                  <div className="flex">
                    ...
                    <div>
                      ...
                      <a href="mailto:info@nutrivida.com" className="text-nutrition-green hover:underline">info@nutrivida.com</a>
                      <p className="text-gray-600 mt-2 mb-1">For appointment scheduling:</p>
                      <a href="mailto:appointments@nutrivida.com" className="text-nutrition-green hover:underline">appointments@nutrivida.com</a>
                    </div>
                  </div>
                  ...
                  <div className="flex">
                    ...
                    <div>
                      ...
                      <a href="tel:+1234567890" className="text-nutrition-green hover:underline">(123) 456-7890</a>
                      <p className="text-gray-600 mt-2 mb-1">Customer Support:</p>
                      <a href="tel:+1234567891" className="text-nutrition-green hover:underline">(123) 456-7891</a>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex space-x-4">
                      <a href="#" className="bg-nutrition-green/10 hover:bg-nutrition-green/20 transition-colors p-2 rounded-full">
                        <svg className="w-6 h-6 text-nutrition-green" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
