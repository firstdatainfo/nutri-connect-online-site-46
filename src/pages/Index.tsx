...
// Executando o pré-carregamento de forma mais eficiente
...
const Index = () => {
  ...
  return <>
      ...
      <main className="w-full overflow-hidden">
        ...
        <section className="py-2 md:py-4 bg-white w-full">
          <div className="container mx-auto px-3 sm:px-4">
            <div className="flex flex-col md:flex-row items-center justify-between mb-4 gap-3">
              <div>
                <h2 className="text-xl sm:text-2xl font-bold mb-2 py-2">Cuidado Individualizado e Especialização</h2>
                ...
                <p className="text-sm md:text-base text-gray-600 mt-2">
                  Nossa equipe é especializada em diferentes áreas da nutrição — clínica, funcional, esportiva e comportamental — garantindo orientação técnica e humanizada.
                </p>
              </div>
              <div className="flex-shrink-0 mt-3 md:mt-0">
                <img src="/lovable-uploads/72e02af0-d74d-4ed9-930a-2d5f6fcdcae0.png" alt="Nutrição saudável" className="h-auto max-h-40 md:max-h-52 object-contain" />
              </div>
            </div>
        ...
        {/* Sobre */}
        <section className="py-4 md:py-8 bg-nutrition-light-blue/20 w-full">
          <div className="container mx-auto px-3 sm:px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-center">
              <div className="order-2 lg:order-1">
                <img src="https://images.unsplash.com/photo-1490818387583-1baba5e638af?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80" alt="Sobre Lidiane Dos Reis" className="rounded-lg shadow-lg h-full w-full object-cover max-h-[320px]" />
              </div>
              <div className="order-1 lg:order-2">
                <h2 className="text-xl md:text-2xl font-bold mb-2">Por que escolher a Lidiane?</h2>
                ...
                <div className="space-y-2">
                  <div className="flex items-start">
                    <div className="bg-nutrition-green/10 rounded-full p-1.5 mr-2 mt-0.5">
                      <svg className="w-3 h-3 md:w-4 md:h-4 text-nutrition-green" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                      </svg>
                    </div>
                    <div>
                      <h3 className="text-sm md:text-base font-semibold">Abordagem Personalizada</h3>
                      <p className="text-xs md:text-sm text-gray-600">Planos personalizados que se adequam ao seu estilo de vida e objetivos específicos.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="text-sm md:text-base font-semibold">Orientação Especializada</h3>
                      <p className="text-xs md:text-sm text-gray-600">Nutricionista certificada com experiência em diversas especialidades.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="text-sm md:text-base font-semibold">Suporte Contínuo</h3>
                      <p className="text-xs md:text-sm text-gray-600">Orientação contínua e ajustes para garantir seu progresso na jornada de saúde.</p>
                    </div>
                  </div>
                </div>
                <div className="mt-3 md:mt-4">
                  <Button asChild className="bg-nutrition-green hover:bg-nutrition-teal text-sm h-9">
        ...
        <section className="py-4 md:py-8 bg-white w-full">
          <div className="container mx-auto px-3 sm:px-4">
            <div className="text-center mb-4">
              <h2 className="text-xl md:text-2xl font-bold mb-1 md:mb-2">Histórias de Sucesso</h2>
        ...
        {/* CTA */}
        <section className="py-6 md:py-8 bg-gradient-to-r from-nutrition-green to-nutrition-teal text-white w-full">
          <div className="container mx-auto px-3 sm:px-4 text-center">
            <h2 className="text-xl md:text-2xl font-bold mb-2">Pronto para Transformar sua Saúde?</h2>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-2">
              <Button asChild size="sm" variant="secondary" className="text-nutrition-green">
                <Link to="/consultation">Agendar Consulta</Link>
              </Button>
              <Button asChild size="sm" className="bg-transparent text-white border border-white hover:bg-white/10">
